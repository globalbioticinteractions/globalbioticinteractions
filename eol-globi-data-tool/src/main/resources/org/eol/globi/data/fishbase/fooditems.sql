...
--
select f.PreySpecCode as 'prey species code', f.foodName as 'food item name', s2.genus as 'food item genus', s2.species as 'food item species', 'food item of', s.speccode as 'consumer species code', s.genus as 'consumer genus', s.species as 'consumer species', 
