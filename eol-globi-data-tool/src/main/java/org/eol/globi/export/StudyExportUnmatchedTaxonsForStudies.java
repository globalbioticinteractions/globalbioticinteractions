...
public class StudyExportUnmatchedTaxonsForStudies implements StudyExporter {

    private GraphDatabaseService graphDbService;

    public StudyExportUnmatchedTaxonsForStudies(GraphDatabaseService graphDatabaseService) {
