...
package org.eol.globi.export.turtle;
 ...
 * <p/>
 * slightly changed to make the turtle writer less verbose (no comments, no tabs).
 */
...
public class TurtleRenderer extends RDFRendererBase {
    ...
    public TurtleRenderer(OWLOntology ontology, OWLOntologyManager manager,
        ...
        verbose = "true".equals(format.getParameter("verbose", "false"));
    }
