...
public class StudyImporterForBarnes extends BaseStudyImporter {
    ...
    public Study importStudy() throws StudyImporterException {
        ...
        Study study = nodeFactory.getOrCreateStudy("Barnes 2008", "C. Barnes et al.", "Centre for Environment, Fisheries and Aquaculture Science, Lowestoft, Suffolk, NR33 0HT  UK", "", "<a href=\"http://www.esapubs.org/Archive/ecol/E089/051/\">Predator and prey body sizes in marine food webs.</a>", "2008", StudyImporterForGoMexSIBase.GOMEXSI_URL);
        try {
