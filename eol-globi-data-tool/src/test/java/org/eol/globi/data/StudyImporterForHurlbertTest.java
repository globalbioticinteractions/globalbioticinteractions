...
public class StudyImporterForHurlbertTest extends GraphDBTestCase {
    ...
    public void importSome() throws StudyImporterException, NodeFactoryException {
        TestParserFactory factory = new TestParserFactory(aFewLines());
