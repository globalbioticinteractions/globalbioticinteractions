...
public class StudyImporterForFishbaseTest extends GraphDBTestCase {
    ...
    public void importFewLines() throws StudyImporterException, NodeFactoryException, IOException {
        ...
        assertThat(citations, hasItem("Hickley, P. and R.G. Bailey. 1987. Food and feeding relationships of fish in the Sudd swamps (River Nile, southern Sudan)."));
        assertThat(citations, hasItem("Rainboth, W.J.1996. Fishes of the Cambodian Mekong.. Mekong."));
        assertThat(citations, hasItem("Trewavas, E.. 1983. Tilapiine fishes of the genera <i>Sarotherodon</i>, <i>Oreochromis</i> and <i>Danakilia</i>."));

        assertThat(citations, hasItem("ICES. 2012. Stomach DatasetImpl."));
