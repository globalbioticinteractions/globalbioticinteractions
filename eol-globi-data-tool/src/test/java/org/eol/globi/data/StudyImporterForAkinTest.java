...
public class StudyImporterForAkinTest extends GraphDBTestCase {
    ...
    public void importAll() throws StudyImporterException, NodeFactoryException {
        StudyImporter importer = new StudyImporterFactory(new ParserFactoryImpl(), nodeFactory).createImporterForStudy(StudyImporterFactory.Study.AKIN_MAD_ISLAND);
    ...
    public void importMappingIssue() throws StudyImporterException, NodeFactoryException {
        ...
        StudyImporter importer = new StudyImporterFactory(new TestParserFactory(csvString), nodeFactory).createImporterForStudy(StudyImporterFactory.Study.AKIN_MAD_ISLAND);
        importer.importStudy();
