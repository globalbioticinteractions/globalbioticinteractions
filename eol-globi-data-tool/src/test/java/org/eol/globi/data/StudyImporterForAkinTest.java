...
public class StudyImporterForAkinTest extends GraphDBTestCase {
    ...
    public void importAll() throws StudyImporterException, NodeFactoryException {
        StudyImporter importer = new StudyImporterFactory(new ParserFactoryImpl(), nodeFactory).createImporterForStudy((Class)StudyImporterForAkin.class);
    ...
    public void importMappingIssue() throws StudyImporterException, NodeFactoryException {
        ...
        StudyImporter importer = new StudyImporterFactory(new TestParserFactory(csvString), nodeFactory).createImporterForStudy((Class)StudyImporterForAkin.class);
        importer.importStudy();
