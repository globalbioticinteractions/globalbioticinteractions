...
public class CachePullThroughTest {
    ...
    public void cache() throws IOException {
        ...
        ContentProvenance contentProvenance = CachePullThrough.cache(URI.create("https://github.com/globalbioticinteractions/template-dataset/archive/main.zip"), cacheDir, new ResourceServiceLocal(new InputStreamFactoryNoop()));
