...
public class ReverseLineReaderFactoryImplTest {
    ...
    public void readFirstLine() throws IOException {
        ...
        LineReader lineReader = new ReverseLineReaderFactoryImpl()
                .createLineReader(file);

        String firstLine = lineReader.readLine();

        assertThat(firstLine, Is.is("three"));
    }
