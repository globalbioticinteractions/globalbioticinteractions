        ...
        Map<InteractType, InteractType> inverseMap = new LinkedHashMap<InteractType, InteractType>() {
            {
                ...
                put(InteractType.ECTOMYCORRHIZAL_HOST_OF, InteractType.HAS_ECTOMYCORRHIZAL_HOST);
                put(InteractType.ARBUSCULAR_MYCORRHIZAL_HOST_OF, InteractType.HAS_ARBUSCULAR_MYCORRHIZAL_HOST);
            }
        };
        ...
        Map<InteractType, Collection<InteractType>> pathMap = new HashMap<InteractType, Collection<InteractType>>() {
            {
                ...
                put(InteractType.ECTOMYCORRHIZAL_HOST_OF, Arrays.asList(InteractType.RELATED_TO, InteractType.CO_OCCURS_WITH, InteractType.INTERACTS_WITH, InteractType.SYMBIONT_OF, InteractType.HOST_OF));
                put(InteractType.ARBUSCULAR_MYCORRHIZAL_HOST_OF, Arrays.asList(InteractType.RELATED_TO, InteractType.CO_OCCURS_WITH, InteractType.INTERACTS_WITH, InteractType.SYMBIONT_OF, InteractType.HOST_OF));
            }
        };
