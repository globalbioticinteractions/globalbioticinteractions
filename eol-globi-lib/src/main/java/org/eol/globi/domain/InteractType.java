...
public enum InteractType implements RelType {
    ...
    HAS_ECTOMYCORRHIZAL_HOST("http://purl.obolibrary.org/obo/RO_0002805", "hasEctomycorrhizalHost", SUBJECT, OBJECT),
    ECTOMYCORRHIZAL_HOST_OF("http://purl.obolibrary.org/obo/RO_0002804", "ectomycorrhizalHostOf", SUBJECT, OBJECT),

    HAS_ARBUSCULAR_MYCORRHIZAL_HOST("http://purl.obolibrary.org/obo/RO_0002807", "hasArbuscularMycorrhizalHost", SUBJECT, OBJECT),
    ARBUSCULAR_MYCORRHIZAL_HOST_OF("http://purl.obolibrary.org/obo/RO_0002806", "arbuscularMycorrhizalHostOf", SUBJECT, OBJECT),
