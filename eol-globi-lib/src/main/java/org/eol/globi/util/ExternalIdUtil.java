...
public class ExternalIdUtil {
    ...
    private static final Map<String, String> PREFIX_MAP = new HashMap<String, String>() {{
        ...
        put(TaxonomyProvider.ID_PREFIX_NBN, "https://species.nbnatlas.org/species/");
        ...
        put(TaxonomyProvider.PBDB.getIdPrefix(), "https://paleobiodb.org/classic/basicTaxonInfo?rdr=1&taxon_no=");
