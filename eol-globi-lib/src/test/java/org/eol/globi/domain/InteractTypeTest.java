...
public class InteractTypeTest {
    ...
    public void typesOf() {
        ...
        assertThat(InteractType.typesOf(SYMBIONT_OF), hasItems(PARASITE_OF, POLLINATES, POLLINATED_BY, HAS_PARASITE, HAS_PATHOGEN, PATHOGEN_OF, HAS_VECTOR, VECTOR_OF, ENDOPARASITE_OF, HAS_ENDOPARASITE, HYPERPARASITE_OF, HAS_HYPERPARASITE, HYPERPARASITOID_OF, HAS_HYPERPARASITOID, ECTOPARASITE_OF, HAS_ECTOPARASITE, PARASITOID_OF, HAS_PARASITOID, FARMED_BY, FARMS, DISPERSAL_VECTOR_OF, HAS_DISPERAL_VECTOR));
