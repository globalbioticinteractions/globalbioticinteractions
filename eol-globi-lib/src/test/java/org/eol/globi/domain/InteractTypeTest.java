...
public class InteractTypeTest {
    ...
    public void typesOf() {
        ...
        assertThat(InteractType.typesOf(SYMBIONT_OF), hasItems(SYMBIONT_OF, PARASITE_OF, POLLINATES, POLLINATED_BY, HAS_PARASITE, HAS_VECTOR, VECTOR_OF, ENDOPARASITE_OF, HAS_ENDOPARASITE, HYPERPARASITE_OF, HAS_HYPERPARASITE, ECTOPARASITE_OF, HAS_ECTOPARASITE, PARASITOID_OF, HAS_PARASITOID, FARMED_BY, FARMS));
        assertThat(InteractType.typesOf(SYMBIONT_OF), not(hasItems(PREYS_UPON, KILLS, KILLED_BY, PREYED_UPON_BY, ATE, EATEN_BY)));
        assertThat(InteractType.typesOf(PARASITE_OF), hasItems(PARASITE_OF, ENDOPARASITE_OF, HYPERPARASITE_OF, ECTOPARASITE_OF, PARASITOID_OF));
