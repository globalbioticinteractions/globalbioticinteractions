...
public class OpenBiodivUtilTest {
    ...
    public void retrieveTaxonFamily() throws IOException {
        Taxon taxon = OpenBiodivUtil.retrieveTaxonHierarchyById("4B689A17-2541-4F5F-A896-6F0C2EEA3FB4", new SparqlClientImpl(getResourceServiceTest()));
    ...
    public void retrieveTaxonSpecies() throws IOException {
        Taxon taxon = OpenBiodivUtil.retrieveTaxonHierarchyById("6A54156A-BE5C-44D7-A9E3-3902DA4CCFAC", new SparqlClientImpl(getResourceServiceTest()));
    ...
    public void retrieveTaxonSpecies2() throws IOException {
        Taxon taxon = OpenBiodivUtil.retrieveTaxonHierarchyById("22A7F215-829B-458A-AEBB-39FFEA6D4A91", new SparqlClientImpl(getResourceServiceTest()));
