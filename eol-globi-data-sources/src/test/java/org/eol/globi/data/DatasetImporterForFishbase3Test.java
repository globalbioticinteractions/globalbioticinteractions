...
public class DatasetImporterForFishbase3Test {
    ...
    public void importDependencies() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importReferences(references, resourceAsStream2, "FB");

        speciesMap = new HashMap<>();
        InputStream resourceAsStream1 = getClass().getResourceAsStream("species_fishbase_first100.tsv");
        DatasetImporterForFishbase3.importSpecies(speciesMap, resourceAsStream1, "FB");
        InputStream resourceAsStream3 = getClass().getResourceAsStream("species_sealifebase_first100.tsv");
        DatasetImporterForFishbase3.importSpecies(speciesMap, resourceAsStream3, "SLB");

        countries = new HashMap<>();
        InputStream resourceAsStream = getClass().getResourceAsStream("countref_fishbase_first100.tsv");
        DatasetImporterForFishbase3.importCountries(countries, resourceAsStream);
    }
    ...
    public void parseFoodItems() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importFoodItemsByFoodName(links::add, is, speciesMap, references, countries, "FB");
        ...
        assertThat(firstItem.get(DatasetImporterForTSV.INTERACTION_TYPE_NAME), Is.is("eats"));
        assertThat(firstItem.get(DatasetImporterForTSV.INTERACTION_TYPE_ID), Is.is("http://purl.obolibrary.org/obo/RO_0002470"));
    }
    ...
    public void parseFoodItemII() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importFoodItemsByFoodII(links::add, is, speciesMap, references, countries, "FB");
    ...
    public void parsePredats() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importPredators(links::add, is, speciesMap, references, countries, "FB");
        ...
        assertThat(firstItem.get(DatasetImporterForTSV.INTERACTION_TYPE_NAME), Is.is("preysOn"));
        assertThat(firstItem.get(DatasetImporterForTSV.INTERACTION_TYPE_ID), Is.is("http://purl.obolibrary.org/obo/RO_0002439"));
    ...
    public void parseDiet() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importDiet(links::add, is, speciesMap, references, countries, "FB");
