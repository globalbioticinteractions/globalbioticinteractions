...
public class DatasetImporterForPensoftIT {
    ...
    public void retrieveTaxonSpecies() throws IOException {
        Taxon taxon = DatasetImporterForPensoft.retrieveTaxonHierarchyById("6A54156A-BE5C-44D7-A9E3-3902DA4CCFAC", new OpenBiodivClient(getResourceServiceTest()));
    ...
    public void retrieveTaxonSpecies2() throws IOException {
        Taxon taxon = DatasetImporterForPensoft.retrieveTaxonHierarchyById("22A7F215-829B-458A-AEBB-39FFEA6D4A91", new OpenBiodivClient(getResourceServiceTest()));
