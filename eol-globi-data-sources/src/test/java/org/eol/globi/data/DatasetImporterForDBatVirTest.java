...
public class DatasetImporterForDBatVirTest {
    ...
    public void extactPubmed() {
        ...
        String referenceId = DatasetImporterForDBatVir.extractFirstPubMedReferenceId(pubMed);
    ...
    public void extractCitation() {
        ...
        String citationClean = DatasetImporterForDBatVir.scrubReferenceCitation(refs);
