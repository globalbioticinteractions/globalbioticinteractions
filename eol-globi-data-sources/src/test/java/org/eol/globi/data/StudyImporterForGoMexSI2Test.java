...
public class StudyImporterForGoMexSI2Test {
    ...
    public void importReferences() throws IOException, StudyImporterException {
        ...
        Map<String, String> contributorMap = StudyImporterForGoMexSI2.collectContributors("bla", CSVTSVUtil.createLabeledCSVParser(CSVTSVUtil.createExcelCSVParse(new StringReader(someReferences))));
