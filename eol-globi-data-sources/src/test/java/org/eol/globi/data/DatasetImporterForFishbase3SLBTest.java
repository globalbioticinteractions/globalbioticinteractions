...
public class DatasetImporterForFishbase3SLBTest {
    ...
    public void importDependencies() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importReferences(references, resourceAsStream2, "SLB");

        speciesMap = new HashMap<>();
        InputStream resourceAsStream1 = getClass().getResourceAsStream("species_sealifebase_first100.tsv");
        DatasetImporterForFishbase3.importSpecies(speciesMap, resourceAsStream1, "SLB");
        InputStream resourceAsStream3 = getClass().getResourceAsStream("species_fishbase_first100.tsv");
        DatasetImporterForFishbase3.importSpecies(speciesMap, resourceAsStream3, "FB");
    ...
    public void parseFoodItems() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importFoodItemsByFoodName(links::add, is, speciesMap, references, countries, "SLB");
    ...
    public void parsePredats() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importPredators(links::add, is, speciesMap, references, countries, "SLB");
    ...
    public void parseDiet() throws StudyImporterException {
        ...
        DatasetImporterForFishbase3.importDiet(links::add, is, speciesMap, references, countries, "SLB");
