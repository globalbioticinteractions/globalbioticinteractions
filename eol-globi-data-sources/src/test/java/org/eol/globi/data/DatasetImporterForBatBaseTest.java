...
public class DatasetImporterForBatBaseTest {
    ...
    public void parseSource() throws IOException {
        ...
        Map<String, String> sourceCitations = DatasetImporterForBatPlant.parseCitations(sourceChunk);
    ...
    public void assertInteractions(Map<String, Taxon> taxa) throws IOException, StudyImporterException {
        ...
        DatasetImporterForBatPlant.parseInteractions(taxa, sources, interactionJson, testListener, locations, getFooPrefixer());
