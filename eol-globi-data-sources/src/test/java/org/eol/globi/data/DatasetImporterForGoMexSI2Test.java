...
public class DatasetImporterForGoMexSI2Test {
    ...
    public void importSingleLine() throws IOException, StudyImporterException {
        ...
        DatasetImporterForGoMexSI2.parseSpecimen(URI.create("test.txt"), "PRED_", new ParseEventHandler() {
            @Override
    ...
    public void importReferences() throws IOException, StudyImporterException {
        ...
        Map<String, String> contributorMap = DatasetImporterForGoMexSI2.collectContributors(URI.create("test.txt"), CSVTSVUtil.createLabeledCSVParser(CSVTSVUtil.createExcelCSVParse(new StringReader(someReferences))));
    ...
    public void polyCoordToWKT() {
        assertThat(DatasetImporterForGoMexSI2.polyCoordsToWKT("((-92.6729107838999,29.3941413332999),(-92.5604838626999,29.2066775354))")
    ...
    public void parseLocation() throws IOException, StudyImporterException {
        ...
        final LabeledCSVParser parser = CSVTSVUtil.createLabeledCSVParser(CSVTSVUtil.createExcelCSVParse(IOUtils.toInputStream(locationLines, StandardCharsets.UTF_8)));
        parser.getLine();
        final Location location = DatasetImporterForGoMexSI2.parseLocation(URI.create("test.txt"), parser);
        ...
        final DateTime eventDate = DatasetImporterForGoMexSI2.parseEventDate(URI.create("test.txt"), parser);
