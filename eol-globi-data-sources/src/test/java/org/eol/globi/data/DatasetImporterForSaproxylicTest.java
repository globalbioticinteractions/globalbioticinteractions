...
public class DatasetImporterForSaproxylicTest {
    ...
    public void parseAssociations() throws IOException, StudyImporterException {
        ...
        DatasetImporterForSaproxylic.parseAssociations(triples::add, IOUtils.toInputStream(someAssociationRows, StandardCharsets.UTF_8));

        assertThat(triples.size(), is(10));
        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{505B49F3-1798-451C-99B0-00011BE9614D}", "mentioned_by", "{DF56D217-13B1-42B1-81A6-64553F91F7B6}")));
    }
    ...
    public void parseOccurrences() throws IOException, StudyImporterException {
        ...
        DatasetImporterForSaproxylic.parseOccurrences(triples::add, IOUtils.toInputStream(someOccurrenceRows, StandardCharsets.UTF_8));

        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{ACF1CDC2-BABD-4B63-AA57-0002A1C918E2}", "classifiedAs", "{BE612DC1-8E9E-4D77-936A-543E865DF829}")));
    }
    ...
    public void parseTaxa() throws IOException, StudyImporterException {
        ...
        final Set<Triple<String, String, String>> triples = new TreeSet<>();
        DatasetImporterForSaproxylic.parseTaxa(triples::add, IOUtils.toInputStream(someTaxaRows, StandardCharsets.UTF_8));
        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{DCCD2CFE-D002-40AB-B93B-000DD0B62999}", "hasName", "Drosophilidae")));
        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{DCCD2CFE-D002-40AB-B93B-000DD0B62999}", "hasRank", "{4665ED8F-3734-406C-8987-E01B25E7D917}")));
    }
    ...
    public void parseLocality() throws IOException, StudyImporterException {
        ...
        DatasetImporterForSaproxylic.parseLocalities(triples::add, IOUtils.toInputStream(someLocalities, StandardCharsets.UTF_8));

        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{02759CAD-38BF-4353-8B37-00919DE7F65F}", "hasName", "Poland")));
    }
    ...
    public void parseReferences() throws IOException, StudyImporterException {
        ...
        final Set<Triple<String, String, String>> triples = new TreeSet<>();
         DatasetImporterForSaproxylic.parseReferences(triples::add, IOUtils.toInputStream(someLocalities, StandardCharsets.UTF_8));

        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{9D773EF5-E522-4527-A404-00297A952B91}", "hasName", "J. Vanhara. 1982. The moravian species of flat footed flies (Diptera, Opetiidae and Platypezidae). vol 23. p 137-142. Folia prirodoved. fak. UJEP Brne.")));
    }
    ...
    public void parseRanksTest() throws IOException, StudyImporterException {
        ...
        DatasetImporterForSaproxylic.parseTaxonRanks(triples::add, IOUtils.toInputStream(someRanks, StandardCharsets.UTF_8));

        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{BF719A88-8ED0-4804-B92A-EE02C0B36351}", "hasName", "Suborder")));
    }
    ...
    public void interactionTypeMap() throws IOException, StudyImporterException {
        ...
        DatasetImporterForSaproxylic.parseInteractionTypeMap(triples::add, IOUtils.toInputStream(aMapping, StandardCharsets.UTF_8));

        assertThat(triples, hasItem(DatasetImporterForSaproxylic.asTriple("{F67E5D97-887B-41D3-9758-257F33767101}", "equivalentTo", InteractType.HAS_PARASITE.getIRI())));
    }
