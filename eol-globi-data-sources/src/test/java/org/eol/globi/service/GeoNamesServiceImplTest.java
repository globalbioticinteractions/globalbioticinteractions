...
public class GeoNamesServiceImplTest {
    ...
    public void assertPacific() throws IOException {
        LatLng point = new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)).findLatLng("Country: Pacific");
    ...
    public void assertTransPecos() throws IOException {
        LatLng point = lookupByGeoNameTerm(new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)));
        assertThat(point, is(notNullValue()));
    ...
    public void assertEarth() throws IOException {
        LatLng point = new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)).findLatLng("Country: General;   Locality: General");
        assertNull(point);
    }

    @Test
    public void retrievePointForNonExistingSpireLocality() throws IOException {
        LatLng point = new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)).findLatLng("Blabla: mickey mouse");
    ...
    public void retrieveAnyGeoNamesId() throws IOException {
        ...
        LatLng point = new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)).getCentroid(2164089L);
        assertThat(point, is(notNullValue()));
    }
    ...
    public void retrieveAnyGeoNamesIdYugoslavia() throws IOException {
        ...
        LatLng point = new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)).getCentroid(7500737L);
    ...
    public void findPointForLocalitys() throws IOException {
        LatLng point = new GeoNamesServiceImpl(new ResourceServiceHTTP(is -> is)).findLatLng("Kerguelen Island");
        assertThat(point, is(notNullValue()));
    }
