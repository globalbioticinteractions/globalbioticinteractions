...
public class StudyImporterForRobledo extends BaseStudyImporter {
    ...
    public StudyNode importStudy() throws StudyImporterException {
        ...
        StudyNode study = nodeFactory.getOrCreateStudy("García-Robledo et al 2013", description, description);
                ...
                for (String plantAbbreviation : abrLookup.keySet()) {
                    ...
                    try {
                        ...
                        if (interactionCode > 0) {
                            SpecimenNode plant = nodeFactory.createSpecimen(study, plantScientificName);
