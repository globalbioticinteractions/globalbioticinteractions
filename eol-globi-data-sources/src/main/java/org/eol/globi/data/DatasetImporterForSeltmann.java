...
public class DatasetImporterForSeltmann extends NodeBasedImporter {
    ...
    public DatasetImporterForSeltmann(ParserFactory parserFactory, NodeFactory nodeFactory) {
