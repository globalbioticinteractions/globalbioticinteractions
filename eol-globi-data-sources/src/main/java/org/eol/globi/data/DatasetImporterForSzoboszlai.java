...
public class DatasetImporterForSzoboszlai extends DatasetImporterWithListener {

    public DatasetImporterForSzoboszlai(ParserFactory parserFactory, NodeFactory nodeFactory) {
