...
public class DatasetImporterForBioInfo extends NodeBasedImporter implements DatasetImporter {
    ...
    public DatasetImporterForBioInfo(ParserFactory parserFactory, NodeFactory nodeFactory) {
