...
public class EcoregionFinderFactoryImpl2 implements EcoregionFinderFactory2 {

    @Override
    public EcoregionFinder2 createEcoregionFinder(EcoregionType2 type) {
        Map<EcoregionType2, EcoregionFinderConfig2> urlTypeMap = getUrlTypeMap();
        return new EcoregionFinderImpl2(urlTypeMap.get(type));
    }

    @Override
    public List<EcoregionFinder2> createAll() {
        List<EcoregionFinder2> finders = new ArrayList<EcoregionFinder2>();
    ...
    private Map<EcoregionType2, EcoregionFinderConfig2> getUrlTypeMap() {
        return new HashMap<EcoregionType2, EcoregionFinderConfig2>() {{
            ...
            EcoregionFinderConfig2 config = new EcoregionFinderConfig2();
            ...
            put(EcoregionType2.TerrestrialEcoregionsOfTheWorld, config);
            ...
            config = new EcoregionFinderConfig2();
            ...
            config.setGeometryLabel("the_geom");
            put(EcoregionType2.MarineEcoregionsOfTheWorld, config);
            ...
            config.setGeometryLabel("the_geom");
            put(EcoregionType2.FreshwaterEcoregionsOfTheWorld, config);
            ...
            config.setGeometryLabel("the_geom");
            put(EcoregionType2.LonghurstBioGeographicalProvinces, config);
        }};
    }
}
