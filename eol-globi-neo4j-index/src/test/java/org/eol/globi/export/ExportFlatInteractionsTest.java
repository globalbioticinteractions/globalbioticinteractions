...
public class ExportFlatInteractionsTest extends GraphDBTestCase {
    ...
    public void importExportCompareResults() throws NodeFactoryException, IOException, ParseException {
        ...
        final String first = "\nEOL:333\t| EOL:333 |\tHomo sapiens\t\tpathElem1 | pathElem 2\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tGLOBI:JUVENILE\tJUVENILE\tGLOBI:BONE\tBONE\tGLOBI:DIGESTATE\tDIGESTATE\tsome:female\tfemale\teats\thttp://purl.obolibrary.org/obo/RO_0002470\tEOL:555\t| EOL:555 |\tCanis lupus\t\tpreyPathElem1 | preyPathElem2\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t12.0\t-45.9\tsome:localeid\tsome locale\t1992-03-30T08:00:00Z\thttps://en.wiktionary.org/wiki/support\t\t\t\t<http://example.com>\tsome/namespace\thttp://example.com\t\t";
    ...
    private void createTestData(Double length) throws NodeFactoryException, ParseException {
        Study myStudy = factory.getOrCreateStudy(new StudyImpl("myStudy", null, null));
        ...
        specimenEatCatAndDog(length, myStudy, "Homo erectus", "EOL:123", RelTypes.COLLECTED, RelTypes.SUPPORTS);
        specimenEatCatAndDog(length, factory.getOrCreateStudy(new StudyImpl("yourStudy", null, null)), "Homo erectus", "EOL:888", RelTypes.COLLECTED, RelTypes.SUPPORTS);
        specimenEatCatAndDog(length, factory.getOrCreateStudy(new StudyImpl("yourStudy2", null, null)), "Homo erectus", "EOL:888", RelTypes.COLLECTED, RelTypes.SUPPORTS);
