...
public class NodeBackedTest extends GraphDBTestCase {
    ...
    public void pickOptimalRelationTraversalDirection() {
        ...
        try (Transaction transaction = getGraphDb().beginTx()) {
            ...
            NodeBacked nodeBacked3 = new NodeBacked(transaction.getNodeById(nodeId1));
            NodeBacked nodeBacked4 = new NodeBacked(transaction.getNodeById(nodeId2));
    ...
    public void assertRelationshipCount(AtomicInteger relationshipCount, long nodeId, int expectedRelationshipCount) {
        ...
        try (Transaction transaction = getGraphDb().beginTx()) {
            ...
            nodeById = transaction.getNodeById(nodeId);
            Iterable<Relationship> relationships = nodeById.getRelationships();
