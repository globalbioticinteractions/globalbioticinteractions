...
public class DatasetImporterForBarnesTest extends GraphDBTestCase {
    ...
    public void importHeadAndTail() throws IOException, NodeFactoryException, StudyImporterException {
        ...
        TestParserFactory parserFactory = new TestParserFactory(new TreeMap<String, String>() {
            {
                put(DatasetImporterForBarnes.RESOURCE_PATH.toString(), firstFourLines);
                put(DatasetImporterForBarnes.REFERENCE_PATH.toString(), "short,full\nBethea et al (2004),something long\nStergiou & Fourtouni 1991,something longer");
            }
        });
