...
public class DatasetImporterForSPIRETest extends GraphDBNeo4jTestCase {
    ...
    private void assertSingleImport(String spireHabitat, String envoId, String envoLabel) throws NodeFactoryException {
        DatasetImporterForSPIRE studyImporterForSPIRE = createImporter();
        TreeMap<String, String> properties = new TreeMap<String, String>();
        properties.put(StudyConstant.TITLE, "the study of men eating dogs");
        properties.put(DatasetImporterForSPIRE.PREY_NAME, "dog");
        properties.put(DatasetImporterForSPIRE.PREDATOR_NAME, "man");
        properties.put(DatasetImporterForSPIRE.LOCALITY_ORIGINAL, "something");
        properties.put(DatasetImporterForSPIRE.OF_HABITAT, spireHabitat);
