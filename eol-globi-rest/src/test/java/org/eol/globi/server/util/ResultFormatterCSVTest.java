...
public class ResultFormatterCSVTest {
    ...
    @Test
    public void toCSVWithJSONMultiLineArray() throws ResultFormattingException {
        String json = "{\"columns\":[\"source_taxon_name\",\"interaction_type\",\"target_taxon_name\"]," +
                "\"data\":[" +
                "    { \"row\": [\"Homo sapiens\",\"preysOn\",[\"Tragelaphus spekii\",\"Kobus kob\"]], \"meta\" : [null, null, null] }," +
                "    { \"row\": [\"Homo sapiens\",\"eats\",[\"Hoplobatrachus occipitalis\",\"Pelusios castaneus\"]], \"meta\" : [null, null, null] }" +
                "  ]" +
                "}";
        InputStream is = IOUtils.toInputStream(json, StandardCharsets.UTF_8);
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        new ResultFormatterCSV().format(is, os);
        assertThat(new String(os.toByteArray(), StandardCharsets.UTF_8),
                is("\"source_taxon_name\",\"interaction_type\",\"target_taxon_name\"\n" +
                        "\"Homo sapiens\",\"preysOn\",\"Tragelaphus spekii\"\n" +
                        "\"Homo sapiens\",\"preysOn\",\"Kobus kob\"\n" +
                        "\"Homo sapiens\",\"eats\",\"Hoplobatrachus occipitalis\"\n" +
                        "\"Homo sapiens\",\"eats\",\"Pelusios castaneus\"\n"));
