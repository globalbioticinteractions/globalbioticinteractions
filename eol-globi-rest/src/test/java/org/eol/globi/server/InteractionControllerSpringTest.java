...
public class InteractionControllerSpringTest extends SpringTestBase {
    ...
    public void bboxWithDotType() {
        ...
        assertThat(interactions.getVersionedQuery(), Is.is(
                "CYPHER 5 " +
                        "WITH " +
                        "point({longitude: -82.203, latitude: 17.077}) AS lowerLeft," +
                        "point({longitude: -79.215, latitude: 20.632}) AS upperRight " +
                        ...
                        "WHERE point.withinBBox(loc." + LocationConstant.LNGLAT + ", lowerLeft, upperRight)" +
