...
public class TaxonSearchUtilTest {
    ...
    public void createQuery() {
        ...
        assertThat(query.getVersionedQuery(), Is.is("CYPHER 1.9 START someTaxon = node:taxons({pathQuery}) MATCH someTaxon-[:SAME_AS*0..1]->taxon WHERE has(taxon.externalId) WITH DISTINCT(taxon.externalId) as externalId, taxon.externalUrl? as externalUrl RETURN externalId as taxon_external_id,externalUrl as taxon_external_url"));
