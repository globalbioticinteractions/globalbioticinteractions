...
public enum ResultObject {
    ...
    public static ResultObject forField(ResultField field) {
        Map<ResultField, ResultObject> fieldToObject = new TreeMap<ResultField, ResultObject>() {{
            ...
            put(ResultField.SOURCE_SPECIMEN_SEX, SOURCE_SPECIMEN);
            put(ResultField.SOURCE_SPECIMEN_SEX_ID, SOURCE_SPECIMEN);
            ...
            put(ResultField.TARGET_SPECIMEN_SEX, TARGET_SPECIMEN);
            put(ResultField.TARGET_SPECIMEN_SEX_ID, TARGET_SPECIMEN);
