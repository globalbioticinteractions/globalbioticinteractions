...
public enum ResultField {
    ...
    STUDY_URL("study_url", "URL associated with the recorded interaction claim (e.g., \"http://www.stoppinginvasives.org/dotAsset/6d3c1060-971d-4e12-bf0e-9d34aefb998c.pdf\")."),
    STUDY_DOI("study_doi", "DOI associated with the recorded interaction claim (e.g., \"10.2317/JKES0811.17.1\")."),
    STUDY_CITATION("study_citation", "Citation associated with the recorded interaction claim. (e.g., \"Kern, W.H. (2004). Dealing with Iguanas in the South Florida Landscape: ENY-714/IN528, 8/2004. EDIS, 2004(15).\")"),
    STUDY_SOURCE_CITATION("study_source_citation", "Citation associated with the datasets containing the recorded interaction claim. (e.g., \"Sabina E. Vlad, Jodey Peyton & Sofie Meeus. 2022. Interactions data on *Iguana iguana* and other taxa from the Cayman Islands.\")"),
    STUDY_SOURCE_ID("study_source_id", "Internal identifier (or namespace) for dataset containing the recorded interaction claim. (e.g., \"globalbioticinteractions/jeught2021\")."),
    ...
    STUDY_SOURCE_DOI("study_source_doi", "DOI (i.e., https://doi.org) associated with the datasets containing the recorded interaction claim (e.g., \"10.5281/zenodo.1436853\")."),
    STUDY_SOURCE_FORMAT("study_source_format", "format of the dataset containing the recorded interaction claim (e.g., \"dwca\")"),
    STUDY_SOURCE_ARCHIVE_URI("study_source_archive_uri", "URI of the datasets containing the recorded interaction claim (e.g., https://zenodo.org/record/1436853/files/globalbioticinteractions/template-dataset-0.0.3.zip)"),
    STUDY_SOURCE_LAST_SEEN_AT("study_source_last_seen_at", "date/time in ISO8601 describing when the dataset containing the recorded interaction claim was last seen. (e.g., \"2022-05-06T14:30:42.917Z\")");
